package com.user.grocerydeliveryapp.util;
...
public class GroceryDriverNotification extends FirebaseMessagingService {
    ...
    private void sendNotification(String message, String title,Map<String,String> map) throws JSONException {
        ...
        if(key.equalsIgnoreCase("orders"))
        {
        ...
        } else  if(key.equalsIgnoreCase("new order"))
        {
            intent = new Intent(this, HomeAct.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
